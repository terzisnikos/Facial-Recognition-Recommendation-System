...
type WidgetProps = {
  title?: undefined | string | JSX.Element | null,
  className?: string,
  ...
  customClose?: null | JSX.Element,
  customExpand?: null | JSX.Element,
  customCollapse?: null | JSX.Element,
  customFullscreen?: null | JSX.Element,
  customReload?: null | JSX.Element,
  customDropDown?: null | JSX.Element,
  prompt?: boolean,
  collapsed?: boolean,
  options?: object,
          ...
          <div className={`${s.widgetControls} widget-controls`}>
            ...
            {refresh && (
              <button onClick={handleReload} id={`reloadId-${randomId}`}>
                ...
                {showTooltip && (
                  <UncontrolledTooltip placement={tooltipPlacement} target={`reloadId-${randomId}`}>
                    Reload
                  </UncontrolledTooltip>
                )}
              </button>
            ...
            {fullscreen && (
              <button onClick={handleFullscreen} id={`fullscreenId-${randomId}`}>
                ...
                {showTooltip && (
                  <UncontrolledTooltip placement={tooltipPlacement} target={`fullscreenId-${randomId}`}>
                    Fullscreen
                  </UncontrolledTooltip>
                )}
              </button>
