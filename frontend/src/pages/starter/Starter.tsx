  ...
  return (
    <div className={s.root}>
      <div className={s.starterBlock}>
        ...
        <p>
          This is a react/nodejs app generated by the <a href="https://flatlogic.com/generator">Flatlogic Web App Generator</a>.
          For guides and documentation please check your local README.md and <a href="https://flatlogic.com/documentation">Flatlogic documentation</a>.
        </p>
